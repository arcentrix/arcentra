...
func (c *FeishuCardChannel) SetAuth(provider notification.IAuthProvider) error {
	if provider == nil {
...
func (c *FeishuCardChannel) GetAuth() notification.IAuthProvider {
...
func (c *FeishuCardChannel) Receive(_ context.Context, _ string) error {
	return nil
}
