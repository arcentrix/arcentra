...
func (c *EmailChannel) SetAuth(provider notification.IAuthProvider) error {
	if provider == nil {
		return nil
	}

	// Email typically uses Basic Auth
	if provider.GetAuthType() != notification.AuthBasic {
...
func (c *EmailChannel) GetAuth() notification.IAuthProvider {
