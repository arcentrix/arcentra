...
func (c *FeishuAppChannel) SetAuth(provider notification.IAuthProvider) error {
	if provider == nil {
		return nil
	}

	// Validate authentication type
	if provider.GetAuthType() != notification.AuthToken &&
		provider.GetAuthType() != notification.AuthAPIKey {
...
func (c *FeishuAppChannel) GetAuth() notification.IAuthProvider {
