...
type MultiPublisher struct {
	publishers []executor.EventPublisher
}

// NewMultiPublisher creates a MultiPublisher.
func NewMultiPublisher(publishers ...executor.EventPublisher) *MultiPublisher {
	filtered := make([]executor.EventPublisher, 0, len(publishers))
