...
func (m *Manager) handleShellScript(ctx context.Context, params json.RawMessage, opts *pipeline.BuiltinOptions) (json.RawMessage, error) {
...
func (m *Manager) handleShellCommand(ctx context.Context, params json.RawMessage, opts *pipeline.BuiltinOptions) (json.RawMessage, error) {
