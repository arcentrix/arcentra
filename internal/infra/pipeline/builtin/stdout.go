...
func (m *Manager) handleStdoutSend(_ context.Context, params json.RawMessage, _ *pipeline.BuiltinOptions) (json.RawMessage, error) {
...
func (m *Manager) handleStdoutSendTemplate(_ context.Context, params json.RawMessage, _ *pipeline.BuiltinOptions) (json.RawMessage, error) {
...
func (m *Manager) handleStdoutSendBatch(_ context.Context, params json.RawMessage, _ *pipeline.BuiltinOptions) (json.RawMessage, error) {
