...
func (m *Manager) handleArtifactsUpload(_ context.Context, params json.RawMessage, opts *pipeline.BuiltinOptions) (json.RawMessage, error) {
...
func (m *Manager) handleArtifactsDownload(_ context.Context, params json.RawMessage, opts *pipeline.BuiltinOptions) (json.RawMessage, error) {
