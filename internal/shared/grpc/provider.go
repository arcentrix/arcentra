...
import (
	...
	"github.com/arcentrix/arcentra/internal/shared/grpc/interceptor"
...
func ProvideGrpcServer(
	...
	interceptor.SetAuthorizer(services.Authorizer)
	...
	server.Register(services, redisClient, mysqlDB, kafkaSettings)
	return server
}
