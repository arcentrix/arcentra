...
type ExecutionContext struct {
	...
	BuiltinManager IBuiltinManager
...
// GetPipeline returns the pipeline (implements BuiltinExecutionContext interface)
func (c *ExecutionContext) GetPipeline() *spec.Pipeline {
	return c.Pipeline
}

// GetWorkspaceRoot returns the workspace root (implements BuiltinExecutionContext interface)
